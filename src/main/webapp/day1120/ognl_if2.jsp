<%@page import="kr.co.sist.vo.OgnlVO"%>
...
<div>
	...
	<form action="index.jsp" method="get">
		...
		<label>사원이름</label> <input type="text" id="ename" name="ename" /><br>
		<input type="submit" value="부서와 사원 조회" class="btn btn-primary btn-sm" /><br>
	</form>

	<jsp:useBean id="oVO" class="kr.co.sist.vo.OgnlVO" scope="page" />
